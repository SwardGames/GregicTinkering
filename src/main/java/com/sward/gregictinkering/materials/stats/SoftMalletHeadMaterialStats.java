...
public record SoftMalletHeadMaterialStats(int durability, float attack) implements IRepairableMaterialStats
{
	public static final MaterialStatsId ID = new MaterialStatsId(GregicTinkeringMod.id("soft_mallet_head"));
	public static final MaterialStatType<SoftMalletHeadMaterialStats> TYPE = new MaterialStatType<>(
		ID, new SoftMalletHeadMaterialStats(1, 1F), RecordLoadable.create(
